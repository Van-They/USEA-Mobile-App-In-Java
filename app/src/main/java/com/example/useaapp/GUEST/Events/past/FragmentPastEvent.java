...
public class FragmentPastEvent extends Fragment {
    ...
    {
        Call<List<com.example.useaapp.GUEST.Events.past.Response_model_guest_event_past>> call = com.example.useaapp.GUEST.Events.past.ApiController_guest_event_past
                .getInstance()
                .getapi()
                .getdata();

        call.enqueue(new Callback<List<com.example.useaapp.GUEST.Events.past.Response_model_guest_event_past>>() {
            @Override
            public void onResponse(Call<List<com.example.useaapp.GUEST.Events.past.Response_model_guest_event_past>> call, Response<List<com.example.useaapp.GUEST.Events.past.Response_model_guest_event_past>> response) {
