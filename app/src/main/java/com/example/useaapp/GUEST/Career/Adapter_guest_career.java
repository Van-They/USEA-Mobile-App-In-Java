...
public class Adapter_guest_career extends RecyclerView.Adapter<Adapter_guest_career.ViewHolder> {
    ...
    List<com.example.useaapp.GUEST.Career.Response_model_guest_career> data;
    Context context;

    public Adapter_guest_career(List<com.example.useaapp.GUEST.Career.Response_model_guest_career> data, Context context) {
        this.data = data;
