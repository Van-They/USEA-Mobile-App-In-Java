package com.example.useaapp.student.student_score.year3;
...
public class FragmentStudentScore_Y3S1S2 extends Fragment {
    ListView List_Score_Y3S1,List_Score_Y3S2;
    View Show_Detail_Y3S1,Show_Detail_Y3S2;
    ArrayList<ModelScore> Semester1,Semester2;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View view = inflater.inflate(R.layout.fragment_student_score__y3_s1_s2, container, false);
        List_Score_Y3S1 = view.findViewById(R.id.student_score_list_y3s1);
        List_Score_Y3S2 = view.findViewById(R.id.student_score_list_y3s2);
        ...
        addDataList1();
        addDataList2();
        List_Score_Y3S1.setAdapter(new Adapter_score_semester(view.getContext(), Semester1));
        ListviewHelper.getLisViewSize(List_Score_Y3S1);
        List_Score_Y3S2.setAdapter(new Adapter_score_semester(view.getContext(), Semester2));
        ListviewHelper.getLisViewSize(List_Score_Y3S2);
        return view;
    }
    private void addDataList1() {
        Semester1 = new ArrayList<>();
        Semester1.add(new ModelScore("Web Development","#1","A","600"));
    ...
    private void addDataList2() {
        ...
        Semester2.add(new ModelScore("Php Programing","#1","A","600"));
