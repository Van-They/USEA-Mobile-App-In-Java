...
public class Adapter_semester1 extends ArrayAdapter<Semester> {
    public Adapter_semester1(@NonNull Context context, ArrayList<Semester> Semester1) {
        super(context, R.layout.custom_item_studyplan, Semester1);
    }
