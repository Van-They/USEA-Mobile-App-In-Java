...
public class Fragment_student_Studyplan_y3s1s2 extends Fragment {

    public static final String text = "txt";
    private final static String SHARE_PREFNAME = "Student_Name";
    SharedPreferences sharedPreferences;
    String st_id;
    TextView student_study_plan_total_hour_y3s1, student_study_plan_total_credit_y3s1, student_study_plan_total_hour_y3s2, student_study_plan_total_credit_y3s2;
    ...
    LinearLayout layout_text_no_data_p3, layout_data_p3;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_study_plan__y3_s1_s2, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        student_study_plan_list_s1 = view.findViewById(R.id.student_study_plan_list_y3s1);
        student_study_plan_list_s1.setLayoutManager(new LinearLayoutManager(getActivity()));

        student_study_plan_list_s2 = view.findViewById(R.id.student_study_plan_list_y3s2);
        student_study_plan_list_s2.setLayoutManager(new LinearLayoutManager(getActivity()));

        student_study_plan_total_hour_y3s1 = view.findViewById(R.id.student_study_plan_total_hour_y3s1);
        student_study_plan_total_credit_y3s1 = view.findViewById(R.id.student_study_plan_total_credit_y3s1);
        student_study_plan_total_hour_y3s2 = view.findViewById(R.id.student_study_plan_total_hour_y3s2);
        student_study_plan_total_credit_y3s2 = view.findViewById(R.id.student_study_plan_total_credit_y3s2);
        layout_text_no_data_p3 = view.findViewById(R.id.layout_text_no_data_p3);
        layout_data_p3 = view.findViewById(R.id.layout_data_p3);
    ...
    public void processdata1() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac3_bach_major_id3_it_y3s1()
                .get_guest_pro_fac_bac3_it_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac3_bach_major_id3_it_y3s2()
                .get_guest_pro_fac_bac3_it_y3s2();
        ...
        call1.enqueue(new Callback<List<Response_model_SemesterStudyPlan>>() {
            ...
            public void onResponse(Call<List<Response_model_SemesterStudyPlan>> call, Response<List<Response_model_SemesterStudyPlan>> response) {
                ...
                student_study_plan_total_hour_y3s1.setText(String.valueOf(totalHour1));
                ...
                if (responsemodels != null && !responsemodels.isEmpty()) {
                    ...
                    ShowDialog.stopDialog();
                    layout_text_no_data_p3.setVisibility(View.VISIBLE);
                    layout_data_p3.setVisibility(View.GONE);
                }
            }
        ...
        call2.enqueue(new Callback<List<Response_model_SemesterStudyPlan>>() {
            ...
            public void onResponse(Call<List<Response_model_SemesterStudyPlan>> call, Response<List<Response_model_SemesterStudyPlan>> response) {
                ...
                student_study_plan_total_hour_y3s2.setText(String.valueOf(totalHour2));
    ...
    public void processdata2() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac3_bach_major_id3_math_y3s1()
                .get_guest_pro_fac_bac3_math_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac3_bach_major_id3_math_y3s2()
                .get_guest_pro_fac_bac3_math_y3s2();
    ...
    public void processdata3() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac2_bach_major_id2_acc_y3s1()
                .get_guest_pro_fac_bac2_acc_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac2_bach_major_id2_acc_y3s2()
                .get_guest_pro_fac_bac2_acc_y3s2();
    ...
    public void processdata4() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac2_bach_major_id2_fin_y3s1()
                .get_guest_pro_fac_bac2_fin_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac2_bach_major_id2_fin_y3s2()
                .get_guest_pro_fac_bac2_fin_y3s2();
    ...
    public void processdata5() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac4_bach_major_id4_mnm_y3s1()
                .get_guest_pro_fac_bac4_mnm_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac4_bach_major_id4_mnm_y3s2()
                .get_guest_pro_fac_bac4_mnm_y3s2();
    ...
    public void processdata6() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_guest
                .getInstance()
                .getapi_fac4_bach_major_id4_kh_y3s1()
                .get_guest_pro_fac_bac4_kh_y3s1();

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_guest
                .getInstance()
                .getapi_fac4_bach_major_id4_kh_y3s2()
                .get_guest_pro_fac_bac4_kh_y3s2();
    ...
    public void processdata8() {
        ...
        Call<List<Response_model_SemesterStudyPlan>> call1 = ApiController_student
                .getInstance()
                .getapi_stu_studyplan_y3s1()
                .get_stu_studyplan_y3s1(st_id);

        Call<List<Response_model_SemesterStudyPlan>> call2 = ApiController_student
                .getInstance()
                .getapi_stu_studyplan_y3s2()
                .get_stu_studyplan_y3s2(st_id);
