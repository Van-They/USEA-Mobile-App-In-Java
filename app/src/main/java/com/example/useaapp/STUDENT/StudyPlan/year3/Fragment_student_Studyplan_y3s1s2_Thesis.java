...
public class Fragment_student_Studyplan_y3s1s2_Thesis extends Fragment {
    ...
    LinearLayout layout_text_no_data_p3_th, layout_data_p3_th;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        return inflater.inflate(R.layout.fragment_study_plan__y3_s1_s2_thesis, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layout_text_no_data_p3_th = view.findViewById(R.id.layout_text_no_data_p3_th);
        layout_data_p3_th = view.findViewById(R.id.layout_data_p3_th);
        ...
        call1.enqueue(new Callback<List<Response_model_SemesterStudyPlan_Thesis>>() {
            ...
            public void onResponse(Call<List<Response_model_SemesterStudyPlan_Thesis>> call, Response<List<Response_model_SemesterStudyPlan_Thesis>> response) {
                ...
                if (responsemodels != null && !responsemodels.isEmpty()) {
                    ...
                    ShowDialog.stopDialog();
                    layout_data_p3_th.setVisibility(View.GONE);
                    layout_text_no_data_p3_th.setVisibility(View.VISIBLE);
                }
            }
