...
public class FragmentStudyPlan_Y4S1S2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //setAdapter
        listView_s1.setAdapter(new Adapter_Studyplan_Semester(requireContext(), semester1));
        ListviewHelper.getLisViewSize(listView_s1);
        listView_s2.setAdapter(new Adapter_Studyplan_Semester(requireContext(), semester2));
