...
public class FragmentStudentScore_Y3S1S2 extends Fragment {
    ...
    LinearLayout layout_no_data, layout_semester_1y3, layout_semester_2y3;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        nestedScrollView = view.findViewById(R.id.layout_nested_scroll_y3);
        layout_no_data = view.findViewById(R.id.layout_text_no_data_y3);
        layout_semester_1y3 = view.findViewById(R.id.layout_semester_1y3);
        layout_semester_2y3 = view.findViewById(R.id.layout_semester_2y3);
        layout_semester_1y3.setVisibility(View.GONE);
        layout_semester_2y3.setVisibility(View.GONE);
        ...
        call1.enqueue(new Callback<List<ModelScore>>() {
            ...
            public void onResponse(Call<List<ModelScore>> call, Response<List<ModelScore>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    layout_semester_1y3.setVisibility(View.VISIBLE);
        ...
        call2.enqueue(new Callback<List<ModelScore>>() {
            ...
            public void onResponse(Call<List<ModelScore>> call, Response<List<ModelScore>> response) {
                ...
                if (responsemodels != null && !responsemodels.isEmpty()) {
                    ShowDialog.stopDialog();
                    layout_semester_2y3.setVisibility(View.VISIBLE);
