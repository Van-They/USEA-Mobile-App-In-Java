...
public class FragmentStudentScore_Y3S1S2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_student_score__y3_s1_s2, container, false);
        return v;
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        student_score_show_detail_y3s1.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        student_score_show_detail_y3s2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(), ScoreDetail.class);
