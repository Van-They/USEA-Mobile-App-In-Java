...
public class Adapter_guest_event_current extends RecyclerView.Adapter<Adapter_guest_event_current.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(holder.Title_guest_event_item.getContext()).load("https://myuseaapp.000webhostapp.com/Guest/event_image/" + data.get(position).getCur_image()).into(holder.eventImg);
    }
