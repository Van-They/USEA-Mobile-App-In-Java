...
import com.example.useaapp.guest.guest_events.upcoming.Response_model_guest_event_upcoming;
...
public class Adapter_guest_event_past extends RecyclerView.Adapter<Adapter_guest_event_past.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(holder.Title_guest_event_item.getContext()).load("http://172.17.19.186/usea_app/event_image/" + data.get(position).getPast_image()).into(holder.eventImg);
    }
