...
import com.example.useaapp.guest.guest_events.announcement.Response_model_guest_event_announcement;
...
public class Detail_guest_about_us_more extends AppCompatActivity {
    ...
    public void processdata()
    {
        ...
        call.enqueue(new Callback<List<Response_model_guest_about_us_more>>() {
            @Override
            public void onResponse(Call<List<com.example.useaapp.guest.guest_more.about_us.Response_model_guest_about_us_more>> call, Response<List<Response_model_guest_about_us_more>> response) {
                responsemodels = response.body();
                com.example.useaapp.guest.guest_more.about_us.Adapter_guest_about_us_more adapter = new com.example.useaapp.guest.guest_more.about_us.Adapter_guest_about_us_more(responsemodels);
            ...
            @Override
            public void onFailure(Call<List<com.example.useaapp.guest.guest_more.about_us.Response_model_guest_about_us_more>> call, Throwable t) {
